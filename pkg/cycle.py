...
class HiddenCycle(Cycle):
    ...
    model: pkg.model.HiddenModel
    msg_acc_fn: typing.Callable[[torch.Tensor, torch.Tensor], torch.Tensor]
    bit_msg_acc_fn: typing.Callable[[torch.Tensor, torch.Tensor], torch.Tensor]
